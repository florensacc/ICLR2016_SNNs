...
\begin{figure}[h]
	...
	\subfigure[SNN with Hbonus integration]{
		\centering
...
\begin{figure}[h]
	\centering
	\subfigure[visit snn6 HB varyCoef]{
		\centering
		\label{fig:visit_snn6_HB_varyCoef}
...
\begin{figure}[h!]
	...
	\subfigure[visit-multi1]{
		\centering
		\label{fig:Maze0}
		\includegraphics[width = 0.4\textwidth]{Figures/visit-multi-1.png}
	}
