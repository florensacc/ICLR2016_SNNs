...
\begin{figure}[h]
	...
	\subfigure[Independently trained policies]{
		\centering
		\subfloat{\includegraphics[width=0.1\textwidth]{Figures/visit_trpo6.png}}
	    \subfloat{\includegraphics[width=0.1\textwidth]{Figures/visit_trpo6.png}}
	    \subfloat{\includegraphics[width=0.1\textwidth]{Figures/visit_trpo6.png}}
        \subfloat{\includegraphics[width=0.1\textwidth]{Figures/visit_trpo6.png}}
        \subfloat{\includegraphics[width=0.1\textwidth]{Figures/visit_trpo6.png}}
	...
	\subfigure[TRPO on regular NN]{
	    ...
	    \includegraphics[width=0.2\textwidth]{Figures/likeSNN-hierarchized-multi-Maze-1-egoSwimmer6-pre500-1pl-500in-100Bs-1000-trpo-swimmer-ego-500_visitation.png}
	}
