...
Our main interest is in solving a collection of downstream tasks, specified via a collection of MDPs $\mdpset$. If these tasks do not share any common structure, we cannot expect to acquire a set of skills that will benefit learning in all of them. We adopt the notion of an agent space \citep{konidaris2011autonomous}. benefit from We assume that 
...
\begin{figure}[h]
	\centering
	\subfigure[Independently trained policies]{
		\centering
	...
	\subfigure[Combined visitation of the independent policies]{
	    ...
	    \includegraphics[trim={2cm 0 2cm 1.5cm}, clip, width=0.2\textwidth]{Figures/likeSNN-hierarchized-multi-Maze-1-egoSwimmer6-pre500-1pl-500in-100Bs-1000-trpo-swimmer-ego-500_visitation.png}
	}
...
\begin{figure}[h!]
	...
	\subfigure[Bilinear-SNN ($\alpha_H=0$) hierarchichy]{
		...
		\includegraphics[width = 0.4\textwidth]{Figures/visit-snn-1Mbisbis.png}
	}
