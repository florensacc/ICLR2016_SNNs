...
%%PA: add paragraph about how the mutual information is computed in practice
...
%%PA: check for cited papers whether they need to be updated [i.e. now accepted somewhere -> in addition to arxiv info, also add the publication venue info]
